        ...
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0F3D5E] via-[#123D5A] to-[#064E4B] text-white px-6 py-9 sm:px-10 sm:py-12">
          ...
          <div className="relative grid grid-cols-1 xl:grid-cols-[1.3fr_.7fr] gap-7 xl:gap-10 items-center">
            <div className="text-start">
              ...
              <p className="mt-4 text-lg sm:text-xl font-black text-[#22D3EE]">{isRtl ? 'محصولات ساختمانی، پیش از خرید در مسیر طراحی دیده می‌شوند.' : 'Building products become visible in design before procurement.'}</p>
              <p className="mt-5 max-w-3xl text-sm sm:text-base leading-8 text-slate-100">{isRtl ? 'ایرانBIMhub تولیدکنندگان را به جامعهٔ طراحی متصل می‌کند؛ محصولات واقعی با آبجکت BIM و اطلاعات فنی در اختیار معماران و مهندسان قرار می‌گیرند، تا طراحان سریع‌تر انتخاب کنند و تولیدکنندگان پیش از خرید دیده شوند.' : 'IranBIMhub connects manufacturers with the design community through real products, BIM objects, and technical information.'}</p>
